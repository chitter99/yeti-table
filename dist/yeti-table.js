...
var Table = /** @class */function (_super) {
    ...
    Table.prototype.render = function () {
        var def = this.generateColumnDefinitions();
        return React.createElement("table", { className: this.props.className }, React.createElement(thead_1.THead, { definition: def }), React.createElement(tbody_1.TBody, { definition: def, data: this.props.data }));
    };
    return Table;
}(React.Component);
exports.Table = Table;
...
exports.TBody = function (props) {
    return React.createElement("tbody", null, props.data.map(function (row, i) {
        return React.createElement(trow_1.TRow, { key: i, definition: props.definition, row: row });
    }));
};
...
exports.THead = function (props) {
    return React.createElement("thead", null, React.createElement("tr", null, props.definition.map(function (def) {
        return React.createElement("th", null, def.header);
    })));
};
...
exports.TRow = function (props) {
    return React.createElement("tr", null, props.definition.map(function (cell, i) {
